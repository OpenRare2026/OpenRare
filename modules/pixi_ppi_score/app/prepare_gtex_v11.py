...
DEFAULT_SOURCE_DIR = Path(os.environ.get("GTEX_V11_SOURCE_DIR", PROJECT_DIR.parent.parent / "data" / "GTEx" / "v11"))
DEFAULT_DATA_DIR = Path(os.environ.get("RARE_PPI_DATA_DIR", PROJECT_DIR.parent.parent / "data"))
