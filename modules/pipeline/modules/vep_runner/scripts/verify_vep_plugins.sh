...
CONFIG="${OPENRARE_VEP_CONFIG:-${OPENRARE_PIPELINE_ROOT}/modules/vep_runner/config/vep_runner_config.json}"
export OPENRARE_DATA_ROOT

python3 - <<'PY' "$CONFIG" "$PIPELINE_ROOT" "$OPENRARE_DATA_ROOT"
import json
import os
import shutil
import sys
