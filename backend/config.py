...
VEP_API_BASE_URL = os.getenv("VEP_API_BASE_URL", "http://172.27.206.113:8000")
...
HPO_API_BASE_URL = os.getenv("HPO_API_BASE_URL", "http://172.27.206.112:9001")
...
PHENOTYPE_HPO_API_BASE_URL = os.getenv("PHENOTYPE_HPO_API_BASE_URL", "http://172.27.206.113:7002")
...
PPI_SCORE_API_BASE_URL = os.getenv("PPI_SCORE_API_BASE_URL", "http://172.27.206.113:9000")
...
REPORT_API_BASE_URL = os.getenv("REPORT_API_BASE_URL", "http://172.27.206.112:7000")
