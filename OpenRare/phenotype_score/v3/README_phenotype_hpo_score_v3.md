...
```text
/mnt/workspace/xlw/phenotype_score/v3/hpo_test.txt
```
...
```text
/mnt/workspace/xlw/phenotype_score/v3/test.P002.csv
```
...
```text
/mnt/workspace/xlw/phenotype_score/v3/results_v2
```
...
```bash
cd /mnt/workspace/xlw/phenotype_score/v3

/mnt/workspace/xlw/phenotype_score/v3/envs/phenotype_score/bin/python -m uvicorn phenotype_hpo_score_api:app --host 0.0.0.0 --port 7003
```
...
```bash
curl -s http://172.27.206.112:7003/runs/{uid}
```

若返回 `status=completion`，可查看输出文件列表：

```bash
curl -s http://172.27.206.112:7003/runs/{uid}/files
```
...
```bash
curl -O http://172.27.206.112:7003/runs/{uid}/files/README_phenotype_hpo_score_v2.md
curl -O http://172.27.206.112:7003/runs/{uid}/files/gene_phenotype_score.csv
curl -O http://172.27.206.112:7003/runs/{uid}/files/variant_phenotype_score.csv
```
...
```text
/mnt/workspace/xlw/phenotype_score/v3
```
...
/mnt/workspace/xlw/phenotype_score/v3/envs/phenotype_score/bin/python phenotype_hpo_score_v2.py \
  --input-csv /mnt/workspace/xlw/phenotype_score/v3/test.P002.csv \
  --hpo-file /mnt/workspace/xlw/phenotype_score/v3/hpo_test.txt \
  --data-dir /mnt/workspace/xlw/phenotype_score/v3/data \
  --outdir /mnt/workspace/xlw/phenotype_score/v3/results_v2
```
...
| `--data-dir` | `/mnt/workspace/xlw/phenotype_score/v3/data` | 公共数据库根目录。 |
