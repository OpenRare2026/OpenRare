#!/usr/bin/env bash
# Install VEP cache (optional) and plugin Perl modules for OpenRare pipline_V3.
# Large annotation databases (CADD, SpliceAI, dbNSFP, etc.) must be downloaded separately;
# see modules/vep_runner/README.md.
set -euo pipefail
